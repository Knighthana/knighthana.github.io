...
![CPU_Virtual](/img/kvm-cpu-virtual.jpg)
...
![Kernel_Module_Support](/img/kvm-kernel-module-support.jpg)
...
![pacman -Syy](/img/kvm-pacman-syy.jpg)
...
![ls mod grep kvm](/img/kvm-lsmod-grep-kvm.jpg)
...
![GUI libvirt](/img/kvm-gui-libvirt.jpg)
...
![VBox-like GUI](/img/kvm-vbox-like-gui.jpg)

啊，熟悉的界面，爷少回！

![Windows Setup](/img/kvm-windows-setup.jpg)

等待安装，已经开始显示汉字了

![Windows XP Setup Chinese](/img/kvm-windows-xp-setup-chinese.jpg)

关于虚拟计算机的硬件信息

![Hardware Info](/img/kvm-hardware-info.jpg)

在磁盘上查找了一下对应的文件，发现所有者是单独的一位用户`libvirt-qemu`，这一点很有意思

![file-owner](/img/kvm-file-owner.jpg)

以及Windows XP由于缺少驱动的原因是既没声音也没网，就这样吧

![No Driver](/img/kvm-no-driver.jpg)
